...
def english_to_sql(english_input):
    sql_translate_string = """You are a helpful SQL assistant that traslates Text written in conversational text to SQL. You must always have a column name, by Aliasing a column to something meaningful if needed. You MUST ONLY return the SQL with nothing else. 
    - This is a SQLLite databse, so use appropriate SQLLite syntax.
